...
public interface IUserDao {
    //查询所有用户可分页
    List<User> selectUserAll(@Param("offset") Integer offset, @Param("limit") Integer limit);

    //查询关注用户可分页
    List<User> selectUserCollectAll(@Param("user") User user, @Param("offset") int offset, @Param("limit") int limit);

    //查询被关注用户可分页
    List<User> selectUserCollectedAll(@Param("user") User user, @Param("offset") int offset, @Param("limit") int limit);
...
////////////////////////////////////////////////////////////
    ...
    //获取关注这个贴子的人
    List<User> selectUserCollectPostAll(@Param("post") Post post, @Param("offset") int offset, @Param("limit") int limit);

    //获取关注标签的用户
    List<User> selectUserCollectLabelAll(@Param("label") Label label, @Param("offset") Integer offset, @Param("limit") Integer limit);
}
