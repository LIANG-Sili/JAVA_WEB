...
public class CollectServiceImpl implements ICollectService {
    ...
    public boolean userNotCollectUser(String username1, String username2) {
        User user1 = iUserDao.selectUserByUsername(username1);
        User user2 = iUserDao.selectUserByUsername(username2);
        if (user1 != null && user2 != null && user1.getUID() == user2.getUID()) {
    ...
    public List<User> getUserCollectUser(String username, Integer offset, Integer limit) {
        ...
        if (temp != null) {
            return iUserDao.selectUserCollectAll(temp, offset, limit);
        }
        return null;
    }
    ...
    public List<User> getUserCollectedUser(String username, Integer offset, Integer limit) {
        User temp = iUserDao.selectUserByUsername(username);
        if (temp != null) {
            return iUserDao.selectUserCollectedAll(temp, offset, limit);
        }
        return null;
    }
    ...
    public List<Post> getUserCollectPost(String username, Integer offset, Integer limit) {
        User temp = iUserDao.selectUserByUsername(username);
        if (temp != null) {
            return iPostDao.selectUserCollectPostAll(temp, offset, limit);
        }
        return null;
    }
...
///
    ...
    public List<Label> getUserCollectLabel(String username, Integer offset, Integer limit) {
        User temp = iUserDao.selectUserByUsername(username);
        if (temp != null) {
            return iLabelDao.selectUserCollectedLabelAll(temp, offset, limit);
        }
        return null;
    }
    ...
    public List<Label> getPostBelongLabel(Integer postID, Integer offset, Integer limit) {
        ...
        if (temp != null) {
            return iLabelDao.selectPostBelongedLabelAll(temp, offset, limit);
        }
        return null;
    }
}
